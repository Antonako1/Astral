...
AS_U0 ASTRAL_CON_SET_COLOUR_F_M(ASTRAL_CON_COLOUR* COLOUR, AS_U32 RGBA) {
    ASTRAL_CON_SET_COLOUR_F(COLOUR, (AS_U8)(RGBA >> 24), (AS_U8)(RGBA >> 16), (AS_U8)(RGBA >> 8), (AS_U8)(RGBA));
}
...
AS_U0 ASTRAL_CON_SET_COLOUR_B_M(ASTRAL_CON_COLOUR* COLOUR, AS_U32 RGBA) {
    ASTRAL_CON_SET_COLOUR_B(COLOUR, (AS_U8)(RGBA >> 24), (AS_U8)(RGBA >> 16), (AS_U8)(RGBA >> 8), (AS_U8)(RGBA));
}

ASTRAL_CON_COLOUR ASTRAL_CON_CREATE_COLOUR_F_B_M(AS_U32 RGBA_F, AS_U32 RGBA_B){
    ASTRAL_CON_COLOUR COLOUR;
    ASTRAL_CON_SET_COLOUR_F_M(&COLOUR, RGBA_F);
    ASTRAL_CON_SET_COLOUR_B_M(&COLOUR, RGBA_B);
    return COLOUR;
}
